RSpec.describe Peatio::Runebase::Wallet do
  let(:wallet) { Peatio::Runebase::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Runebase::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Runebase::Wallet::SUPPORTED_SETTINGS))
    end
  end
